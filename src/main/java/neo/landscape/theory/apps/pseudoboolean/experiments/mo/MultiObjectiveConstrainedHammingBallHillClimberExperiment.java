...
public class MultiObjectiveConstrainedHammingBallHillClimberExperiment implements Process {
    ...
    public void execute(String[] args) {
        ...
        MultiObjectiveConstrainedHammingBallHillClimberForInstanceOf rballfio = (MultiObjectiveConstrainedHammingBallHillClimberForInstanceOf) new MultiObjectiveConstrainedHammingBallHillClimber(
